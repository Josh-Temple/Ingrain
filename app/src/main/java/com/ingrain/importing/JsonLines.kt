...
data class JsonLineCard(
    ...
    val concept_domain: String? = null,
    val concept_one_liner: String? = null,
    val concept_proposer: String? = null,
    val concept_year: Int? = null,
    val canonical_example: String? = null,
    val counter_example: String? = null,
    val common_misuse: String? = null,
    val contrast_points: String? = null,
    val evidence_level: String? = null,
    val sources: String? = null,
    val confusion_cluster: String? = null,
